...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%/gadgets/proxy?refresh=%refresh%&url=%url%", //"//${Cur['default.domain.unlocked.client']}${Cur['gadgets.uri.proxy.path']}?container=%container%&refresh=%refresh%&url=%url%%rewriteMime%",
  ...
  "rpc" : {
    ...
    "parentRelayUrl" : "/catpic/rpc_relay.html",
  ...
  "opensocial" : {
    ...
    "path" : "http://%host%/gadgets/rpc",
    // Path to issue invalidate calls
    "invalidatePath" : "http://%host%/gadgets/rpc",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
       "person" : ["id", {"name" : ["familyName", "givenName", "unstructured"]}, "thumbnailUrl", "displayName"],
  ...
  "osapi.services" : {
    ...
    "http://%host%/gadgets/rpc": ["people.get", "activities.get", "activitystreams.get", 
    "people.create","activities.create", "activitystreams.create", "messages.get",  "messages.send", "messages.create"]
    // ["container.listMethods", "viewerFriends.list", "people.get","activities.get", 
