//NOTE: edited version to support task-based pattern 
//
...
namespace Catpic.Utils.OAuth
{
    ...
    public class OAuthManager
    {
        ...
        /// </returns>
        public Task<OAuthResponse> AcquireRequestToken(string uri, string method)
        {
            NewRequest();
        ...
        ///   poauth_token=foo&something_else=bar.
        /// </returns>
        public Task<OAuthResponse> AcquireAccessToken(string uri, string method, string pin)
        {
            NewRequest();
